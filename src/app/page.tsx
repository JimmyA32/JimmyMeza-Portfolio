...
export default function Home() {
  ...
  // Eliminamos el export aquí para evitar el error
  function Header() {
    return (
  ...
  return (
    <Flex fillWidth paddingTop="l" paddingX="l" direction="column" alignItems="center" flex={1}>
      ...
      <Flex position="relative" as="section" overflow="hidden" fillWidth minHeight="0" maxWidth={68} direction="column" alignItems="center" flex={1}>
        <Flex as="main" direction="column" justifyContent="center" fillWidth fillHeight padding="l" gap="l">
          <Flex mobileDirection="column" fillWidth gap="24">
            <Flex position="relative" flex={2} paddingTop="56" paddingX="xl" direction="column" justifyContent="center" alignItems="center" style={{ marginBottom: '50px', marginTop: '-45px' }}>
            ...
            <Flex position="relative" flex={4} gap="24" marginBottom="104" direction="column">
              <Flex direction="column" alignItems="center" gap="16">
                <InlineCode className="shadow-m" style={{ marginTop: '70px', width: 'fit-content', padding: 'var(--static-space-8) var(--static-space-16)', backdropFilter: 'blur(var(--static-space-1))', fontSize: '24px' }}>
      ...
      <Flex as="footer" 
		...
		onBackground="neutral-weak">© 2024 Jimmy Meza</Text>
        <Flex gap="12">
          <Button 
